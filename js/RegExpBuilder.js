...
function RegExpBuilder(oConfig) {
	// internal ideas:
	// get alias list
	// create more alias at onece
	// 0.5.0 add all regex signs
	...
	var _aAliasList = [];
	var _oConfig = _loadConfiguration(oConfig, _oDefaultValues);
	...
	// ######### matches #########
	/**
	 * Adds a free text to a pattern. Free means no escaping is done, so it is possible to use regex
	 * symbols here.
	 * 
	 * @public
	 * @since 0.1.0
	 ...
	 */
	this.matchesRegExp = function(oRegExp) {
	 ...
	 */
	this.matchesBuilder = function(oRegExpBuilder) {
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesFor = function(sCharacters) {
		_add("[" + sCharacters + "]");
		return this;
	};

	/**
	 * Adds a matcher for any digit. So it matches 0 to 9. This is equivalent to the regex function
	 * '[0-9]'
	 * 
	 * @public
	 * @since 0.4.0
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesAnyDigit = function() {
		return this.matchesFor("0-9");
	};

	/**
	 * Adds a matcher for any alphabetical letter. So it matches a to z and A to Z. This is
	 * equivalent to the regex function '[a-zA-Z]'
	 * 
	 * @public
	 * @since 0.4.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesLetter = function() {
		return this.matchesFor("a-zA-Z");
	};

	/**
	 * Adds a matcher for any alphabetical uppercase letter. So it matches A to Z. This is
	 * equivalent to the regex function '[A-Z]'
	 * 
	 * @public
	 * @since 0.4.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesUppercaseLetter = function() {
		return this.matchesFor("A-Z");
	};

	/**
	 * Adds a matcher for any alphabetical lowercase letter. So it matches a to z. This is
	 * equivalent to the regex function '[a-z]'
	 * 
	 * @public
	 * @since 0.4.0
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesLowercaseLetter = function() {
		return this.matchesFor("a-z");
	};

	/**
	 * Adds a negative matcher for a list of possible characters. It is possible to provide a range
	 * with a '-' This is equivalent to the regex function '[^]'
	 * 
	 * @public
	 * @since 0.1.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesNotFor = function(sCharacters) {
		_add("[^" + sCharacters + "]");
		return this;
	};
	 ...
	 * escaped. If the config attribute wrapTextInsideGroup is true than this will generare a new
	 * regex group with the text inside. Else it using non-capturing parentheses.
	 * 
	 * @public
	 * @since 0.1.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesText = function(sText) {
		if (sText.length !== 0) {
	 ...
	 * define a minimum and a maximum or an exact number This is equivalent to the regex function
	 * '{x,x}' or '{x}' where x is an integer
	 * 
	 * @public
	 * @since 0.1.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesTimes = function(iMin, iMax) {
		if (iMax) {
			_add("{" + iMin + "," + iMax + "}");
		} else {
			_add("{" + iMin + "}");
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.oneOrMoreTimes = function(sText) {
		_add("+");
		return this;
	};
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.zeroOrOneTimes = function(sText) {
		_add("?");
		return this;
	};
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesWordBoundary = function() {
		_add("\\b");
		return this;
	};
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.matchesNotWordBoundary = function() {
		_add("\\B");
		return this;
	};
	...
	/**
	 * Ends a group. A validation is done if a corresponding open group exists if groupValidation is
	 * turned on. This is equivalent to the regex function '('.
	 * 
	 * @public
	 * @since 0.1.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 * @throws {RegExpBuilderException}
	 *             if a group is closed with no open group and the corresponding attribute in the
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.startLookAheadFor = function() {
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.startNegatedLookAhead = function() {
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.endNegatedLookAhead = function() {
		_endLookAhead();
		return this;
	};

	/**
	 * Adds a matcher for the group with the specified group number. No validation is done if this
	 * group exists. This is equivalent to the regex function '\\x', where x is a group number
	 * 
	 * @public
	 * @since 0.1.0
	 * @memberof RegExpBuilder.prototype
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.useGroup = function(iGroupNumber) {
		_add("\\" + iGroupNumber);
		return this;
	};
	 ...
	 *             somebody other
	 */
	this.addAlias = function(sMethodName, sAliasName) {
	 ...
	 * @return {RegExpBuilder} the current instance for method chaining
	 */
	this.deleteAlias = function(sAliasName) {
		var bFound = false;
		var iFoundElementIndex;
		_aAliasList.forEach(function(oAlias, iIndex) {
		...
		if (bFound) {
			...
			_removeFromArray(_aAliasList, iFoundElementIndex);
		}
		return bFound;
	}
	...
	/**
	 * Returns a new RegExp which matches exact the regex pattern which was build with the methods
	 * of this class. A validation for not closed groups is done if the config attribute
	 * 'groupValidation' is set to true. After this method was called, this instance shouldn't be
	 * used furthermore for regex building, becuase this can produces unexpectet regex pattern.
	 * 
	 * @public
	 * @since 0.1.0
	 * @memberof RegExpBuilder.prototype
